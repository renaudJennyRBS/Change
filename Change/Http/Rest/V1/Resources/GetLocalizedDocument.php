...
/**
 * @name \Change\Http\Rest\V1\Resources\GetLocalizedDocument
 */
class GetLocalizedDocument
{
	...
	protected function generateResult($event, $document, $LCID)
	{
		...
		/* @var $documentLink \Change\Http\Rest\V1\Resources\DocumentLink */
	...
	/**
	 * @param \Change\Http\Rest\V1\Resources\DocumentResult $result
