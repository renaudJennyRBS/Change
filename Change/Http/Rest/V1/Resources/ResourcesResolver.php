...
/**
 * @name \Change\Http\Rest\V1\Resources\ResourcesResolver
 */
class ResourcesResolver implements \Change\Http\Rest\V1\NameSpaceDiscoverInterface
{
	/**
	...
	public function resolve($event, $resourceParts, $method)
	{
		...
		$event->getApplication()->getLogging()->info(__METHOD__ . ' ' . var_export($relativePath, true));
		// id
