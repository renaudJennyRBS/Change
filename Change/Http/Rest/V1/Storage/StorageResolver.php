...
/**
 * @name \Change\Http\Rest\V1\Storage\StorageResolver
 */
class StorageResolver implements \Change\Http\Rest\V1\NameSpaceDiscoverInterface
{
	/**
	...
	public function getNextNamespace($event, $namespaceParts)
	{
		...
		{
			$names = $event->getApplicationServices()->getStorageManager()->getStorageNames();
		}
		else
		{
			return $namespaces;
