...
class I18nManagerTest extends \ChangeTests\Change\TestAssets\TestCase
{
	...
	public function testGetSupportedLCIDs()
	{
		...
		$logging = new \Change\Logging\Logging();
		$logging->setConfiguration($config);
		$logging->setWorkspace($application->getWorkspace());
;		$manager->setLogging($logging);
	...
	public function testTransForLCID()
	{
		...
		$syncManager->setEventManagerFactory(new EventManagerFactory($this->getApplication()));
		$syncManager->setConfiguration($config);
		$syncManager->setWorkspace($manager->getWorkspace());
		$syncManager->setLogging($this->getApplicationServices()->getLogging());
