...
use Change\Http\Rest\Controller;
...
{
	/**
	 * @return \Change\Http\Rest\Controller
	 */
	 ...
	 * @param \Change\Http\Rest\Controller $controller
	 * @return \Change\Http\Rest\Controller
	 */
	...
	public function testOnException($controller)
	{
		...
		$this->assertInstanceOf('\Change\Http\Rest\Result\ErrorResult', $result);

		/* @var $result \Change\Http\Rest\Result\ErrorResult */
	...
	public function testOnDefaultJsonResponse($event)
	{
		...
		/* @var $controller \Change\Http\Rest\Controller */
