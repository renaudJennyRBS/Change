...
(function ($) {
	...
	function documentListDirectiveFn ($filter, $location, i18n, REST, Loading, Utils, ArrayUtils, Breadcrumb) {
		...
		return {
			restrict    : 'E',
			transclude  : true,
			templateUrl : 'Change/Admin/js/directives/document-list.twig',
			...
			compile : function (tElement, tAttrs) {
				...
				if (angular.isUndefined(tAttrs.modificationDate) || tAttrs.modificationDate === 'true') {
					columns.push({
						...
						"label"  : i18n.trans('m.change.admin.admin.js.modification-date | ucf'),
				...
				return function linkFn (scope) {
					...
					scope.preview = function (index) {
						...
						Loading.start(i18n.trans('m.change.admin.admin.js.loading-preview | ucf'));
