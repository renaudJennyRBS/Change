(function () {
	...
	app.config(['$routeProvider', function ($routeProvider)
	{
		...
		. when(
			'/clipboard',
			{
				templateUrl : 'Change/Admin/clipboard/list.twig',
	...
	function ChangeAdminClipboardController ($scope, DocumentList, Breadcrumb, Clipboard, MainMenu) {
		...
		MainMenu.loadModuleMenu("Change_Admin_clipboard");
	}
	...
	app.controller('Change_Admin_ClipboardController', ChangeAdminClipboardController);
