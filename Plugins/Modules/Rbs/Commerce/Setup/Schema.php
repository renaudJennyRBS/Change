	...
	public function getTables()
	{
		if ($this->tables === null)
		{
			...
			$td->addField($schemaManager->newIntegerFieldDefinition('id')->setNullable(false)->setAutoNumber(true))
				...
				->addField($schemaManager->newNumericFieldDefinition('total_amount_without_taxes')->setNullable(true))
				->addField($schemaManager->newNumericFieldDefinition('total_amount_with_taxes')->setNullable(true))
				->addField($schemaManager->newNumericFieldDefinition('payment_amount')->setNullable(true))
