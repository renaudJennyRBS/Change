...
class Install extends \Change\Plugins\InstallBase
{
	...
	public function executeApplication($plugin, $application, $configuration)
	{
		...
		$configuration->addPersistentEntry('Change/Events/DocumentManager/Rbs_Commerce', '\Rbs\Commerce\Events\DocumentManager\Listeners');
		...
		$configuration->addPersistentEntry('Rbs/Commerce/Events/CatalogManager/Rbs_Commerce', '\Rbs\Commerce\Events\CatalogManager\Listeners');
		...
		$configuration->addPersistentEntry('Rbs/User/Events/UserManager/Rbs_Commerce', '\Rbs\Commerce\Events\UserManager\Listeners');
