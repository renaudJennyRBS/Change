...
class Register implements ListenerAggregateInterface
{
	...
	public function attach(EventManagerInterface $events)
	{
		...
		{
			$body = array('
	<script type="text/javascript" src="Rbs/Theme/js/admin.js">​</script>
	<script type="text/javascript" src="Rbs/Theme/PageTemplate/controllers.js">​</script>
	<script type="text/javascript" src="Rbs/Theme/PageTemplate/editor.js">​</script>
	<script type="text/javascript" src="Rbs/Theme/Theme/controllers.js">​</script>
	<script type="text/javascript" src="Rbs/Theme/Theme/editor.js">​</script>');
