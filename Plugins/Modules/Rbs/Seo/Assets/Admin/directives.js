(function () {
	...
	app.directive('rbsDocumentUrlManager', ['$http', 'RbsChange.REST', 'RbsChange.NotificationCenter', 'RbsChange.Utils', 'RbsChange.ErrorFormatter', function ($http, REST, NotificationCenter, Utils, ErrorFormatter)
	{
		return {
			restrict : 'E',
			scope : {
			...
			templateUrl : 'Rbs/Seo/document-url-manager.twig',
