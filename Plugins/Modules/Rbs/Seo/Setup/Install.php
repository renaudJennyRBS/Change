		...
		if ($cm->getCollection('Rbs_Seo_Collection_SitemapChangeFrequency') === null)
		{
			...
			try
			{
				...
				$item->getCurrentLocalization()->setTitle($applicationServices->getI18nManager()
					->trans('m.rbs.seo.document.documentseo.sitemap-change-frequency-always', array('ucf')));
				$item->save();
				...
				$item->getCurrentLocalization()->setTitle($applicationServices->getI18nManager()
					->trans('m.rbs.seo.document.documentseo.sitemap-change-frequency-hourly', array('ucf')));
				$item->save();
				$collection->getItems()->add($item);
				...
				$item->setLabel('daily');
				$item->getCurrentLocalization()->setTitle($applicationServices->getI18nManager()
					->trans('m.rbs.seo.document.documentseo.sitemap-change-frequency-daily', array('ucf')));
				$item->save();
				$collection->getItems()->add($item);
				...
				$item->getCurrentLocalization()->setTitle($applicationServices->getI18nManager()
					->trans('m.rbs.seo.document.documentseo.sitemap-change-frequency-weekly', array('ucf')));
				$item->save();
				$collection->getItems()->add($item);
				...
				$item->getCurrentLocalization()->setTitle($applicationServices->getI18nManager()
					->trans('m.rbs.seo.document.documentseo.sitemap-change-frequency-monthly', array('ucf')));
				$item->save();
				$collection->getItems()->add($item);
				...
				$item->getCurrentLocalization()->setTitle($applicationServices->getI18nManager()
					->trans('m.rbs.seo.document.documentseo.sitemap-change-frequency-yearly', array('ucf')));
				$item->save();
				$collection->getItems()->add($item);
				...
				$item->setLabel('never');
				$item->getCurrentLocalization()->setTitle($applicationServices->getI18nManager()
					->trans('m.rbs.seo.document.documentseo.sitemap-change-frequency-never', array('ucf')));
				$item->save();
				$collection->getItems()->add($item);
