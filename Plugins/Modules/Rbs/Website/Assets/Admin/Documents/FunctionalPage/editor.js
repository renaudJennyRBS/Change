(function($) {
	...
	function Editor($rootScope, REST, $routeParams) {
		return {
			restrict: 'A',
	...
	Editor.$inject = [ '$rootScope', 'RbsChange.REST', '$routeParams' ];
	app.directive('rbsDocumentEditorRbsWebsiteFunctionalPageNew', Editor);
	app.directive('rbsDocumentEditorRbsWebsiteFunctionalPageEdit', Editor);
	app.directive('rbsDocumentEditorRbsWebsiteFunctionalPageTranslate', Editor);
})(window.jQuery);