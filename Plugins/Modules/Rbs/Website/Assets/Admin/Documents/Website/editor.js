(function() {
	...
	Editor.$inject = ['RbsChange.REST', 'RbsChange.User'];
	angular.module('RbsChange').directive('rbsDocumentEditorRbsWebsiteWebsiteNew', Editor);
	angular.module('RbsChange').directive('rbsDocumentEditorRbsWebsiteWebsiteEdit', Editor);
})();