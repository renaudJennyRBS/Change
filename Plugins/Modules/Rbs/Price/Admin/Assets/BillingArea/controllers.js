(function ()
{
	...
	function ListController($scope, Breadcrumb, MainMenu, i18n)
	{
		Breadcrumb.resetLocation([
			...
			[i18n.trans('m.rbs.price.admin.js.billingarea-list | ucf'), "Rbs/Price/BillingArea"]
		]);
	...
	app.controller('Rbs_Price_BillingArea_ListController', ListController);
	...
	function FormController($scope, Breadcrumb, FormsManager, i18n)
	{
		...
		FormsManager.initResource($scope, 'Rbs_Price_BillingArea');
	}

	FormController.$inject = ['$scope', 'RbsChange.Breadcrumb', 'RbsChange.FormsManager', 'RbsChange.i18n'];
	app.controller('Rbs_Price_BillingArea_FormController', FormController);
})();