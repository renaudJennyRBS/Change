...
class Register implements ListenerAggregateInterface
{
	...
	<script type="text/javascript" src="Rbs/Price/Tax/controllers.js">​</script>
	<script type="text/javascript" src="Rbs/Price/Tax/editor.js">​</script>
	<script type="text/javascript" src="Rbs/Price/BillingArea/controllers.js">​</script>
	<script type="text/javascript" src="Rbs/Price/BillingArea/editor.js">​</script>');
			...
			$menu = array(
				'entries' => array(
					...
					, 'url' => 'Rbs/Price', 'section' => 'ecommerce', 'keywords' => $i18nManager->trans('m.rbs.price.admin.js.module-keywords'))
				));
