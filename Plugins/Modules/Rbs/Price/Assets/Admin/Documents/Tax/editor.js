(function() {
	...
	function rbsDocumentEditorRbsPriceTax() {
		return {
			restrict: 'A',
	...
	angular.module('RbsChange').directive('rbsDocumentEditorRbsPriceTaxNew', rbsDocumentEditorRbsPriceTax);
	angular.module('RbsChange').directive('rbsDocumentEditorRbsPriceTaxEdit', rbsDocumentEditorRbsPriceTax);
})();