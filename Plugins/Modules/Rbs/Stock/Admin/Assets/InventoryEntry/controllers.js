(function ()
{
	...
	function ListController($scope, Breadcrumb, MainMenu, i18n)
	{
		Breadcrumb.resetLocation([
			...
			[i18n.trans('m.rbs.stock.admin.js.inventoryentry-list | ucf'), "Rbs/Stock/InventoryEntry"]
		]);
	...
	app.controller('Rbs_Stock_InventoryEntry_ListController', ListController);
	...
	function FormController($scope, Breadcrumb, FormsManager, i18n)
	{
		...
		FormsManager.initResource($scope, 'Rbs_Stock_InventoryEntry');
	}

	FormController.$inject = ['$scope', 'RbsChange.Breadcrumb', 'RbsChange.FormsManager', 'RbsChange.i18n'];
	app.controller('Rbs_Stock_InventoryEntry_FormController', FormController);
})();