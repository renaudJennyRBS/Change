(function ()
{
	...
	app.controller('Rbs_Catalog_BillingArea_ListController', ListController);
	...
	function FormController($scope, Breadcrumb, FormsManager, i18n)
	{
		...
		FormsManager.initResource($scope, 'Rbs_Catalog_BillingArea');
	}

	FormController.$inject = ['$scope', 'RbsChange.Breadcrumb', 'RbsChange.FormsManager', 'RbsChange.i18n'];
	app.controller('Rbs_Catalog_BillingArea_FormController', FormController);
})();