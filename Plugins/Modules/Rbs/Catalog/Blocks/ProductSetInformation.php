...
/**
 * @name \Rbs\Catalog\Blocks\ProductSetInformation
 */
class ProductSetInformation extends Information
{
	/**
	...
	public function onInformation(\Change\Events\Event $event)
	{
		...
		$this->addInformationMetaForDetailBlock('Rbs_Catalog_ProductSet', $i18nManager);
