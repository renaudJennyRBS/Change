(function ()
{
	...
	function Editor($timeout, $http, REST, EditorManager)
	{
		return {
			restrict : 'A',
			templateUrl : 'Document/Rbs/Catalog/ProductSet/editor.twig',
			replace : false,
			...
			link: function (scope, elm, attrs, editorCtrl)
			{
				...
				editorCtrl.init('Rbs_Catalog_ProductSet');
			}
		};
	}

	Editor.$inject = ['$timeout', '$http', 'RbsChange.REST', 'RbsChange.EditorManager'];
	angular.module('RbsChange').directive('rbsDocumentEditorRbsCatalogProductset', Editor);
})();