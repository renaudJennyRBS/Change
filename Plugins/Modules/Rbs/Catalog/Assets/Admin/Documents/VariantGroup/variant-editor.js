(function ()
{
	...
	angular.module('RbsChange').directive('rbsDocumentEditorRbsCatalogVariantGroupEditor',
		['RbsChange.REST', '$timeout', '$routeParams', 'RbsChange.Breadcrumb', 'RbsChange.i18n', 'RbsChange.UrlManager',
			function Editor(REST, $timeout, $routeParams, Breadcrumb, i18n, UrlManager)
			{
				return {
					restrict: 'A',
