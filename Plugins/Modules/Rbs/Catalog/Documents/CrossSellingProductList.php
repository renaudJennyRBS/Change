...
class CrossSellingProductList extends \Compilation\Rbs\Catalog\Documents\CrossSellingProductList
{
	...
	protected function attachEvents($eventManager)
	{
		...
		//Unicity check
		$eventManager->attach(array(Event::EVENT_CREATE, Event::EVENT_UPDATE), array($this, 'onDefaultSave'), 3);
	}
	 ...
	 * @return string|null
	 */
	protected function getLabelFromCrossSellingType($collectionManager)
	{
