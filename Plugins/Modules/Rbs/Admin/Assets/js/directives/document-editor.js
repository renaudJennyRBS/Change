...
(function($) {
	 ...
	 * </pre>
	 */
	app.directive('rbsDocumentEditorTranslate',
		['$location', '$q', 'RbsChange.Events', 'RbsChange.NotificationCenter', 'RbsChange.REST', 'RbsChange.i18n',
			function($location, $q, Events, NotificationCenter, REST, i18n) {
				return {
					restrict: 'A',
