	...
	app.directive('rbsFormSimpleFilter', ['RbsChange.i18n', '$timeout', function (i18n, $timeout) {
		return {
			...
			template :
				...
				'<input autocapitalize="off" autocomplete="off" autocorrect="off" placeholder="' + i18n.trans('m.rbs.admin.admin.js.search | ucf | etc') + '" type="text" ng-keyup="keyup($event)" ng-keydown="keydown($event)" ng-model="internalFilter"/>',
