(function () {
	...
	app.config(['$provide', function ($provide)
	{
		...
		{
			$delegate.routesForLocalizedModels(['Rbs_Geo_Country', 'Rbs_Geo_TerritorialUnit', 'Rbs_Geo_AddressField']);
			$delegate.routesForModels(['Rbs_Geo_Address', 'Rbs_Geo_Zone', 'Rbs_Geo_AddressFields', 'Rbs_Geo_Address']);
