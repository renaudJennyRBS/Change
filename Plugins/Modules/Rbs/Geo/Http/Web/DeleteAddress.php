...
/**
 * @name \Rbs\Geo\Http\Web\DeleteAddress
 */
class DeleteAddress extends \Change\Http\Web\Actions\AbstractAjaxAction
{
	/**
	...
	public function execute(\Change\Http\Web\Event $event)
	{
		...
		$success = $genericServices->getGeoManager()->deleteAddress($arguments['id']);
		if (!$success)
		{
			throw new \RuntimeException('Address deletion failed', 999999);
		}
