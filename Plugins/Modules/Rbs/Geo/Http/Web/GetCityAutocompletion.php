...
/**
 * @name \Rbs\Geo\Http\Web\GetCityAutocompletion
 */
class GetCityAutocompletion extends \Change\Http\Web\Actions\AbstractAjaxAction
{
	/**
	...
	public function execute(\Change\Http\Web\Event $event)
	{
		if ($event->getRequest()->getMethod() === 'POST')
		{
			...
			$cities = $geoManager->getCityAutocompletion($params);
